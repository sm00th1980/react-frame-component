...
const Frame = function (_Component) {
  ...
  function Frame(props, context) {
    ...
    const _this = _possibleConstructorReturn(this, (Frame.__proto__ || Object.getPrototypeOf(Frame)).call(this, props, context));
...
Frame.defaultProps = {
  ...
  initialContent: '<!DOCTYPE html><html><head></head><body><div class="region-content"></div></body></html>'
};
